  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "₽15,000",
      annualPrice: "₽12,000",
      description: "Для знакомства с AI-возможностями",
      features: [
        "Анализ бизнес-процессов",
        "Рекомендации по AI-внедрению",
    ...
    },
    {
      ...
      features: [
        "Разработка AI-решения",
        "Интеграция с существующими системами",
        "Обучение команды",
        "Автоматизация до 5 процессов",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Выберите подходящий пакет услуг для автоматизации и развития вашего бизнеса <br /> с помощью искусственного
            интеллекта
          </p>
        </div>
        <div className="pt-4">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Консультация" ? "text-gray-800" : plan.name === "Стандарт" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Консультация" ? "Начните сегодня:" : "Все функции Консультации +"}
              </div>
