...
export function Header() {
  const navItems = [
    { name: "Услуги", href: "#features-section" }, // Изменить с #services-section на #features-section
    { name: "Тарифы", href: "#pricing-section" },
    { name: "Кейсы", href: "#testimonials-section" },
  ]
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <span className="text-foreground text-xl font-semibold">Stepan Ivanov AI</span>
          </div>
